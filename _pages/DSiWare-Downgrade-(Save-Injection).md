...
---
如果你是11.0.0或11.1.0的版本, 请跟随这个向导，利用DSiWare降级NFIRM.
{: .notice}

This takes advantage of an oversight which allows DSiWare titles to read and write anywhere in NAND.
{: .notice--info}

请准备好等待20分钟(New 3DS)到1小时(Old 3DS)的心理准备. Slowhax (waithax) 就是因为这个得名的.
{: .notice--info}

This is a currently working implementation of the "FIRM partitions known-plaintext" exploit detailed [here](https://www.3dbrew.org/wiki/3DS_System_Flaws).
{: .notice--info}

在被替换成破解存档之前，你的DSiWare存档会被备份
{: .notice--info}

#### 你需要什么

* 你的3DS已经拥有(或安装了)下列DSiWare漏洞游戏中的一个*(你必须已经安装了，他们都从eShop踢出了)*
  + **Fieldrunners**
  + **Legends of Exidia**
  + **Guitar Rock Tour**  
  + **The Legend of Zelda: Four Swords (Anniversary Edition)**  
* 一个[Homebrew Launcher (无浏览器)](homebrew-launcher-(no-browser))入口 或者 (在 11.0.0 EUR / USA) [Homebrew Launcher (Browser)](homebrew-launcher-(browser)) 或者 [Homebrew Launcer(声音)](homebrew-launcher-(sound).html)入口
